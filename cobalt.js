...
function cbTaxChartSvg(w,h,list){
  ...
  if(maxM>=1){
    const cumulativeLine=(key,color,width,dash,opacity) => {
    ...
    cumulativeLine('domProfit','#4ecdc4',1.9,'3 4','.86');
    cumulativeLine('fgnProfit','var(--acc)',1.9,'6 4','.88');
    cumulativeLine('profit',acc3,2.8,'','.98');
    // 누적 예상 세액 추이 라인
