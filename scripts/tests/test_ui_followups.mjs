...
assert.match(styleSource, /\.cb-dash-insight-grid\{display:grid;grid-template-columns:minmax\(210px,.82fr\)[\s\S]*minmax\(245px,.9fr\)/, '대시보드 TOP5 폭을 줄이고 기여도 위젯용 네 번째 열 추가')
